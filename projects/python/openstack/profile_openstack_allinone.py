...
profile_def = {
    ...
    "osDeploymentSettings": {
        "osCustomAttributes": [
            ...
            {
                "name": "IP_ALLOC_POOL_START",
                "value": config.IP_ALLOC_POOL_START
            },
            {
                "name": "IP_ALLOC_POOL_END",
                "value": config.IP_ALLOC_POOL_END
            },
            {
                "name": "NEUTRON_EXT_CIDR",
                "value": config.NEUTRON_EXT_CIDR
            },
            {
                "name": "NEUTRON_EXT_GW",
                "value": config.NEUTRON_EXT_GW
            },
            {
                "name": "SERVER_IP",
            ...
            {
                "name": "SERVER_MASK",
                "value": config.SERVER_MASK
            },
            {
                "name": "SERVER_GW",
                "value": config.SERVER_GW
            },
            {
                "name": "DNS_IP",
                "value": config.DNS_IP
